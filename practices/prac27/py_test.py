...
compile_process = subprocess.Popen(["g++", "/home/themightyooze147/SDR/practices/prac26/file_to_byte.cpp", "-o", "my_program"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
